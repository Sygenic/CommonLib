...
{
	public Task HandleAsync(EventA evnt, CancellationToken cancellationToken)
	{
...
{
	public Task HandleAsync(EventB evnt, CancellationToken cancellationToken) => throw new NotImplementedException();
}
